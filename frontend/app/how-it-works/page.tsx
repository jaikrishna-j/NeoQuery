    ...
    <main className="min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="space-y-12">
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#00d4ff]">What is RAG?</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#00d4ff]">The Process</h2>
            <div className="space-y-6">
              <div className="border-l-4 border-[#00d4ff] pl-6">
                <h3 className="text-xl font-semibold mb-2">1. File Upload & Processing</h3>
                <p className="text-[#b0b0b0]">
                  When you upload a file, NeoQuery processes it based on its type:
                </p>
                <ul className="list-disc list-inside mt-2 space-y-1 text-[#888] ml-4">
              ...
              <div className="border-l-4 border-[#00d4ff] pl-6">
                <h3 className="text-xl font-semibold mb-2">2. Text Chunking & Embedding</h3>
                <p className="text-[#b0b0b0]">
              ...
              <div className="border-l-4 border-[#00d4ff] pl-6">
                <h3 className="text-xl font-semibold mb-2">3. Vector Storage</h3>
                <p className="text-[#b0b0b0]">
              ...
              <div className="border-l-4 border-[#00d4ff] pl-6">
                <h3 className="text-xl font-semibold mb-2">4. Question Processing</h3>
                <p className="text-[#b0b0b0]">
              ...
              <div className="border-l-4 border-[#00d4ff] pl-6">
                <h3 className="text-xl font-semibold mb-2">5. Answer Generation</h3>
                <p className="text-[#b0b0b0]">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#00d4ff]">Powered by OpenAI</h2>
            <p className="text-[#b0b0b0] leading-relaxed">
              NeoQuery uses OpenAI&apos;s state-of-the-art models for both embeddings and chat completion. 
              The system uses <code className="bg-[#1a1a1a] px-2 py-1 rounded text-[#00d4ff]">text-embedding-ada-002</code> for 
              generating embeddings and <code className="bg-[#1a1a1a] px-2 py-1 rounded text-[#00d4ff]">GPT-4</code> for 
              generating answers. This ensures high-quality, accurate responses to your questions.
            </p>
          </section>

          <section className="mt-12 p-6 bg-[#1a1a1a] border border-[#333] rounded-lg">
            <h2 className="text-2xl font-semibold mb-4 text-[#00d4ff]">Privacy & Security</h2>
            <p className="text-[#b0b0b0]">
